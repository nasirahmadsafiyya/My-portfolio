...
function navbar() {
  ...
  <div>
   ...
   <motion.span initial={{opacity:0.5, scale:0.5}} animate={{opacity:1, scale:1}} className='text-2xl text-center font-black text-black py-3'>SafiyyaNasir</motion.span>
