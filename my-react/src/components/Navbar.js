...
function Navbar() {
    ...
    return (
        <nav className='text-slate-100 items-center p-0 max-v-[1240px] mx-auto px-4 bg-blue-500 rounded-lg flex justify-between text-2xl z-1'>
            <div>
                <h1 className='font-bold w-full p-5'>SafiyyaNasir</h1>
            </div>

            <div className='p-2 justify-between hidden'>
            ...
            <div className={!nav ? 'fixed top-0 left-0 w-[40%] h-full       border-r-blue-950 text-white bg-blue-500 uppercase text-1xl': 'fixed left-[-100%]'}>
